...
import { DataFiltersModal } from './components/data-filters/data-filters-modal';
...
@NgModule({
  ...
  declarations: [MapComponent, VisComponent, MainComponent, DataFiltersModal],
  providers: [DataService, FilterService, ParametersService],
  bootstrap: [MainComponent],
  entryComponents: [DataFiltersModal, MainComponent],
})
