...
export class ScatterChart 
{
    ...
    constructor(element: ElementRef, private dataService: DataService, private filterService: FilterService, private paramsService: ParametersService) 
    {
        ...
        this.paramsService.getSearchIdEmitter().subscribe( (searchId: string)=>
        {
            if(searchId === "none") {
                ...
                this.data = this.dataService.getBusinesses();
    ...
    private _buildChart()
    {
        ...
        cells
            ...
            .each(function (d: any) 
            {
                ...
                if (!data[0] && !data[0].resolutions && !(tRes in data[0].resolutions)) data = [];
                ...
                circles
                    ...
                    .attr("cx", function (d: any) {
                        return d.resolutions ? that.xScale(d.resolutions[tRes].x) : '';
                    })
                    .attr("cy", function (d: any) { return d.resolutions ? that.yScale(d.resolutions[tRes].y): ''; })
                    .attr("r", 4)
                    .attr("opacity", 1.0)
                    .style("fill", function (d: any) { return that.dataService.getColor(d.cityId); });
    ...
    private _buildSearch()
    {
        ...
        let features = this.dataService.getBusinesses();
