...
macx{
    ...
    QMAKE_LFLAGS += -L$$JAVA_HOME/lib/server/ -ljvm -Xlinker -rpath -Xlinker $$JAVA_HOME/lib/server/
    QMAKE_CXXFLAGS += /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/System/Library/Frameworks/JavaNativeFoundation.framework/Versions/A/Headers/
}
